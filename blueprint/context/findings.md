...
### F-09 [P3] open - API response shapes are hand-duplicated between server and client
...
### F-10 [P3] open - The documented `CardWithDetails` shape is missing three fields the code returns
