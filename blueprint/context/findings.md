...
**Resolution:** Re-deleted the latest batch of 6 (2026-08-29, during feature 19a's `/implement` Step 1) on the strength of the same-session precedent already approved for the identical situation in feature 18. Reopened rather than left `fixed`, since the underlying cause is still unaddressed and it will keep coming back.
